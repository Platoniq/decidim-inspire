...
# This migration comes from decidim_time_tracker (originally 20260708090000)
class CreateTimeTrackerSkills < ActiveRecord::Migration[7.0]
  # Guarded: staging may already have these tables from an earlier copy of
  # this migration that ran under a different timestamp.
  def up
